...
const { MONGO } = process.env, { connect, connection, model, Schema, Types } = require("mongoose");
...
client.once("ready", async() => {
    ...
    registerMessage.edit({
        content: "To register for one of our courses select from options in the dropdown menu",
        components: [row],
    });
});
